...
5. If you cannot determine a meaningful answer from the agent results, say so clearly.
6. Answer in the **same language as the user's question**.
7. Be concise: 1–4 sentences is ideal. Expand only if the topic genuinely requires it.
8. Use Markdown for emphasis (bold, italic, lists) when it improves readability.
"""
